...
/* harmony import */ var _parts_timer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parts/timer.js */ "./src/js/parts/timer.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_parts_tabs_js__WEBPACK_IMPORTED_MODULE_0__["default"])(); // Timer

  Object(_parts_timer_js__WEBPACK_IMPORTED_MODULE_1__["default"])(); // Modal

  Object(_parts_modal_js__WEBPACK_IMPORTED_MODULE_2__["default"])(); // Slider

  Object(_parts_slider_js__WEBPACK_IMPORTED_MODULE_3__["default"])(); // Calc
...
function calc() {
  var priceInputs = document.querySelectorAll('.counter-block-input'),
  ...
  for (var i = 0; i < priceInputs.length; i++) {
    priceInputs[i].addEventListener('input', function (event) {
      ...
      if (/^(?!0.*$)(?!,$)([0-9]{1,9})$/.test(target.value)) {} else {
        target.value = '';
      }
    });
  }
...
function modal() {
  ...
  for (var _i = 0; _i < phoneInput.length; _i++) {
    phoneInput[_i].addEventListener('input', function (event) {
      var target = event.target;
      target.value = target.value.replace(/[^0-9+]/, ''); // if (/^[+]{1}([0-9]{0,17})?$/.test(target.value)) {
      // } else {
      //     target.value = '';
      // }
    });
